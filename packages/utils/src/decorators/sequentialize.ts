...
interface SequentializeOptions<T extends (...args: any[]) => any> {
	/**
 ...
 */
export function sequentialize<T extends (...args: any[]) => any>(
	...
	return (_target: any, key: string, descriptor: PropertyDescriptor) => {
		...
		descriptor.value = function (this: any, ...args: any[]) {
			...
			const dedupeKey = getDedupingKey?.(...(args as Parameters<T>)) ?? defaultResolver(...args);
